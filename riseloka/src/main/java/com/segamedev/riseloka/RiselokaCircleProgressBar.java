 ...
 *
 */
public class RiselokaCircleProgressBar extends View {
    ...
    public RiselokaCircleProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     * so don't call the {@link RiselokaCircleProgressBar#setProgress(float)} directly within this method.
     *
